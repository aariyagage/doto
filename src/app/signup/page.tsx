        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--bg-primary)] p-4">
            ...
            <Card className="w-full max-w-md bg-[var(--bg-panel)] border-gray-200 dark:border-gray-800 shadow-lg rounded-2xl">
                <CardHeader>
                    ...
                    <CardDescription className="font-ui">Start turning your videos into ideas.</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <ul className="text-xs space-y-1 mt-1 font-ui">
                                {checks.map(c => (
                                    <li
                                        key={c.label}
                ...
                <CardFooter className="flex justify-center">
                    <Link href="/login" className="text-sm font-ui text-[var(--muted-foreground)] hover:text-[var(--text-primary)] transition-colors">
